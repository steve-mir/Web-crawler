...
/**
 * A Web crawler used to search for content(s) within a specific website.
 * All of the links in which the content(s) occur are stored in a file called crawler.log
...
public class SearchCrawler extends JFrame {
    ...
    private void actionSearch(){
        //If stop button clicked, tirn crawling flag off
        if (crawling) {
            crawling = false;
            return;
        }
        ...
        //Validate that matches log file has been emtered
    ...
    private boolean isRobotAllowed(URL urlToCheck) {
        ...
        if (disallowList == null) {
            ...
            try {
                ...
                /*
                 * Assume robot is allowed since an exception is thrown if the robot file
                 * doesn't exist.
                 */
                return true;
            }
    ...
    public void crawl(String startUrl, int maxUrls, boolean limitHost, String searchString, boolean caseSensitive) {
        ...
        while (crawling && toCrawlList.size() > 0) {
            ...
            /*
             * If the page was downloaded successfully, retrieve all its links and then see
